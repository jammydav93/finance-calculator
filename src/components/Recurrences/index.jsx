...
const showDateCol = (formValues, type, index) => {
  const regularity = path([type, index, 'regularity'], formValues);
  const regularityConfig = RECURRENCE_OPTIONS.find(i => i.value === regularity);
